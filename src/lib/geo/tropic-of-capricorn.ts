export const TROPIC_OF_CAPRICORN_REFERENCE_LATITUDE = -23.4364;
...
export function getTropicParallelCircumferenceKm(latitude = TROPIC_OF_CAPRICORN_REFERENCE_LATITUDE): number {
